--[[      _       ,-'REGUI`-._    (,-.`._,'( By Author |\`-/|        `-.-' \ )-----`( , o o)               `-       \`_---_


    Written by author    MIT License        https://github.com/meowza1/ungui]]
local ReGui = {
--// Package data
Version = "1.4.2",
Author = "Depso",
...
ActiveTooltips = {},
IniSettings = {},
AnimationConnections = {}}ReGui.Icons = {
...
Character = "rbxassetid://13285102351",}ReGui.Accent = {
--// ReGui acent colors
...
[string]: any}-- If you are forking just to edit this, please use ReGui:DefineTheme insteadlocal ThemeConfigs = ReGui.ThemeConfigsThemeConfigs.DarkTheme = {
Values = {
...
Init = "Selected"
},}--// Global flags for stylingtype FlagFunc = {
Data: {
...
Object: GuiObject}ReGui.ElementFlags = {
{
...
[any]: any }type ObjectTable = { 
[GuiObject]: any }type TagsList = {
[GuiObject]: string }--// Compatibility local EmptyFunction = function() end
local GetHiddenUI = get_hidden_gui or gethuilocal NewReference = cloneref or function(Ins): Instance 
return Ins end--// Service handlerslocal Services = setmetatable({}, {
__index = function(self, Name: string)

local Service = game:GetService(Name)

return NewReference(Service)
end,})--// Core functions --// Serviceslocal HttpService = game:GetService("HttpService")
local Players: Players = Services.Playerslocal CoreGui = Services.CoreGuilocal UserInputService = Services.UserInputServicelocal TweenService = Services.TweenServicelocal RunService = Services.RunService--// Local playerlocal LocalPlayer = Players.LocalPlayerReGui.PlayerGui = LocalPlayer.PlayerGuiReGui.Mouse = LocalPlayer:GetMouse()--// Animation classlocal Animation = ReGui.Animationtype AnimationTween = {
Object: Instance,
NoAnimation: boolean?,
Tweeninfo: TweenInfo?,
EndProperties: {},
Completed: (() -> any?)?}function Animation:Tween(Data: AnimationTween): Tween?
...
return MasterTweenendtype Animate = {
NoAnimation: boolean?,
Objects: ObjectTable,
Tweeninfo: TweenInfo?,
Completed: () -> any,}function Animation:Animate(Data: Animate): Tween
local NoAnimation = Data.NoAnimation
...
return BaseTweenendtype HeaderCollapseToggle = {
Rotations: {
...
NoAnimation: boolean?,
Collapsed: boolean,
Tweeninfo: TweenInfo?,}function Animation:HeaderCollapseToggle(Data: HeaderCollapseToggle)
--// Check configuration
...
return Tweenend--// Signal servicetype SignalClass = {
Connections: {
...
local Signaling = ReGui.Signalinglocal Signal: SignalClass = {}Signal.__index = Signalfunction Signal:Fire(...)
...
local Connections = self:GetConnections()
table.insert(Connections, Func)end
function Signal:DisconnectConnections()
local Connections = self:GetConnections()
table.clear(Connections)end
...
table.insert(Table, NewPosition, Value)end
...
return math.round(Percentage)end
...
Merge = Merge or {}
Class.__index = Class
return setmetatable(Merge, Class)end
...
return TickRange < ClickThresholdend
...
--// Bind events
RunService:BindToRenderStep("ReGui_InputUpdate", Enum.RenderPriority.Input.Value, InputUpdate)end
function ReGui:GetVersion(): string
return self.Versionend
function ReGui:IsMobileDevice(): boolean
return UserInputService.TouchEnabledend
function ReGui:IsConsoleDevice(): boolean
return UserInputService.GamepadEnabledend
function ReGui:GetScreenSize(): Vector2
return workspace.CurrentCamera.ViewportSizeend
...
return Animate and self.Animation or TweenInfo.new(0)end
...
local Data = self:GetAnimationData(Object)
local Connections = Data.Connections
table.insert(Connections, Connection)end
function ReGui:SetAnimationsEnabled(Enabled: boolean)
self.NoAnimations = not Enabledend
...
PaddingTop = Padding
})endexport type ConnectDrag = {
DragStart: () -> nil,
DragEnd: () -> nil,
DragMovement: () -> nil,}function ReGui:ConnectDrag(Frame: GuiObject, Data)
...
}))endtype MakeDraggableFlags = {
Move: Instance,
Grab: Instance,
Enabled: boolean?,
OnUpdate: ((Vector2) -> ...any)?,
DragBegin: ((InputObject) -> ...any)?,
StateChanged: ((MakeDraggableFlags) -> any)?}function ReGui:MakeDraggable(Config: MakeDraggableFlags)
--// Unpack config
...
return Interfaceendexport type MakeResizableFlags = {
MinimumSize: Vector2,
MaximumSize: Vector2?,
--Grab: Instance,
Resize: Instance,
OnUpdate: (UDim2) -> ...any}function ReGui:MakeResizable(Config: MakeResizableFlags)
...
return Name:find("Touch") or Name:find("Mouse")endexport type DetectHover = {
OnInput: ((boolean, InputObject?) -> ...any?)?,
Anykey: boolean?,
MouseMove: boolean?,
MouseOnly: boolean?,
MouseEnter: boolean?,
Hovering: boolean?,}function ReGui:DetectHover(Object: GuiObject, Config: DetectHover)
Config = Config or {}
--// Unpack configuration
...
return Cache[Object]endtype UpdateColors = {
Object: GuiObject,
Tag: (string|table),
NoAnimation: boolean?,
Theme: string?,
TagsList: TagsList?,
Tweeninfo: TweenInfo?}function ReGui:UpdateColors(Config: UpdateColors)
--// Unpack config
...
EndProperties = Properties
})endexport type MultiUpdateColorsConfig = {
Objects: ObjectsTable,
TagsList: TagsList?,
Theme: string?,
Animate: boolean?,
Tweeninfo: TweenInfo?}function ReGui:MultiUpdateColors(Config: MultiUpdateColorsConfig)
...
return setmetatable({}, Metadata)end
...
Func(Child)
endendexport type ApplyFlags = {
Object: Instance,
Class: table,
WindowClass: table?}function ReGui:ApplyFlags(Config: ApplyFlags)
...
endend
function ReGui:CreateBuiltinPrefab(Name: string): GuiObject
	local function New(ClassName: string, Props: table?, Parent: Instance?): Instance
	...
	local function AddLabel(Parent: Instance)
		New("TextLabel", {
			Name = "Label",
			BackgroundTransparency = 1,
			Size = UDim2.fromScale(1, 1),
	...
	local function AddIcon(Parent: Instance)
		New("ImageLabel", {
			Name = "Icon",
			BackgroundTransparency = 1,
			Size = UDim2.fromScale(1, 1),
	...
	elseif Name == "InputBox" then
		local Input = New("TextBox", {Name = "InputBox", Text = ""})
		AddLabel(Input)
		return Input
	elseif Name == "Image" then
		return New("ImageLabel", {Name = "Image", BackgroundTransparency = 1})
	elseif Name == "VideoPlayer" then
		return New("VideoFrame", {Name = "VideoPlayer"})
	elseif Name == "ResizeGrab" then
		return New("TextButton", {Name = "ResizeGrab", Text = ""})
	elseif Name == "ModalEffect" then
		return New("Frame", {
			Name = "ModalEffect",
			Size = UDim2.fromScale(1, 1),
	...
	if ButtonLike[Name] then
		local Button = New("TextButton", {Name = Name, Text = ""})
		AddLabel(Button)
		AddIcon(Button)
		return Button
	end
...
local Prefabs = typeof(Folder) == "Instance" and Folder:FindFirstChild("Prefabs") or nil
local Prefab = Prefabs and Prefabs:FindFirstChild(Name)
local Object = Prefab and Prefab:Clone() or self:CreateBuiltinPrefab(Name)
if not Prefab then
self:Warn("Missing prefab:", Name, "- using builtin replacement")
end
--// Apply properties
if Properties then 
...
return Func(Self, ...)
endendtype MakeCanvas = {
Element: Instance,
WindowClass: WindowClass?,
Class: {}?}function ReGui:MakeCanvas(Config: MakeCanvas)
--// Unpack ReGui data
...
return setmetatable({}, Meta)end--// Ini servicefunction ReGui:GetIniData(Class): table
...
local IniSettings = self.IniSettings
IniSettings[Flag] = Elementendtype OnElementCreateData = {
Flags: table,
Object: GuiObject,
Canvas: table}function ReGui:OnElementCreate(Data: OnElementCreateData)
...
return Mouse.X, Mouse.Yend
function ReGui:SetWindowFocusesEnabled(Enabled: boolean)
self.WindowFocusesEnabled = Enabledend
...
MoveTableItem(Windows, WindowClass, 1)end
...
end)end--// Container classlocal Elements = ReGui.ElementsElements.__index = Elementsfunction Elements:GetObject()
return self.RawObjectend
...
WindowClass:TagElements(Objects)end
...
return ReGui:GetThemeKey(nil, Key)end
...
ContentCanvas.Interactable = not FocusedendReGui:DefineElement("Dropdown", {
Base = {
...
return Class, Object
end,})ReGui:DefineElement("OverlayScroll", {
Base = {
...
end,})ReGui:DefineElement("Overlay", {
Base = {
...
export type Image = {
Image: (string|number),
Callback: ((...any) -> unknown)?}ReGui:DefineElement("Image", {
Base = {
...
Video: (string|number),
Callback: ((...any) -> unknown)?}ReGui:DefineElement("VideoPlayer", {
Base = {
...
Text: string?,
DoubleClick: boolean?,
Callback: ((...any) -> unknown)?,}ReGui:DefineElement("Button", {
Base = {
...
Selected: boolean?,
Disabled: boolean?,
Callback: ((...any) -> unknown)?,}ReGui:DefineElement("Selectable", {
Base = {
...
Image: (string|number),
Callback: ((...any) -> unknown)?}ReGui:DefineElement("ImageButton", {
Base = {
...
Create = Elements.Image,})ReGui:DefineElement("SmallButton", {
Base = {
...
type KeyId = (Enum.UserInputType | Enum.KeyCode)export type Keybind = {
Value: Enum.KeyCode?,
...
WaitForNewKey: ((Keybind) -> any)?,}ReGui:DefineElement("Keybind", {
Base = {
...
return Class, Object
end})ReGui:DefineElement("ArrowButton", {
Base = {
...
Bold: boolean?,
Italic: boolean?,
Font: string?}ReGui:DefineElement("Label", {
Base = {
...
end,})------// MenuBar classlocal MenuBar = {
Engaged = false}MenuBar.__index = MenuBarfunction MenuBar:SetEngaged(Engaged: boolean)
...
return Popup, MenuDataendReGui:DefineElement("MenuBar", {
Base = {},
...
return Meta, Object
end,})ReGui:DefineElement("MenuButton", {
Base = {
...
Create = Elements.Selectable})----// TabsBar classlocal TabBarClass = {
ColorTags = {
...
return Tab.MatchBy == Match or Tab == Matchend
...
return selfendexport type Tab = {
Name: string,
Focused: boolean?,
TabButton: boolean?,
Closeable: boolean?,
OnClosure: (Tab) -> nil,
Icon: (string|number)?}function TabBarClass:CreateTab(Config: Tab): Elements
Config = Config or {}
ReGui:CheckConfig(Config, {
...
NoTabsBar: boolean?,
NoAnimation: boolean?,} & TabBarReGui:DefineElement("TabSelector", {
Base = {
...
Icon: string?,
IconRotation: number?,
Callback: ((...any) -> unknown)?,}ReGui:DefineElement("RadioButton", {
Base = {
...
UntickedImageSize: UDim2,}ReGui:DefineElement("Checkbox", {
Base = {
...
return Class, Object
end,})ReGui:DefineElement("Radiobox", {
Base = {
...
SetModel: (self: Viewport, Model: Model, PivotTo: CFrame?) -> Model,}ReGui:DefineElement("Viewport", {
Base = {
...
SetDisabled: (InputText, Disabled: boolean) -> InputText,}ReGui:DefineElement("InputText", {
Base = {
...
Increase: (InputInt) -> nil,}ReGui:DefineElement("InputInt", {
Base = {
...
return Class, Object
end,})ReGui:DefineElement("InputTextMultiline", {
Base = {
...
CheckLineCount: (Console) -> Console}ReGui:DefineElement("Console", {
Base = {
...
ClearRows: (Table) -> unknown,}ReGui:DefineElement("Table", {
Base = {
...
export type List = {
Spacing: number?}ReGui:DefineElement("List", {
Base = {
...
SetCollapsed: (CollapsingHeader, Open: boolean) -> CollapsingHeader}ReGui:DefineElement("CollapsingHeader", {
Base = {
...
return Canvas, Object
end,})ReGui:DefineElement("TreeNode", {
Base = {
...
Text: string?}ReGui:DefineElement("Separator", {
Base = {
...
export type Canvas = {
Scroll: boolean?,
Class: table?}ReGui:DefineElement("Canvas", {
Base = {},
...
return Canvas, Object
end,})ReGui:DefineElement("ScrollingCanvas", {
Base = {
...
export type Region = {
Scroll: boolean?}ReGui:DefineElement("Region", {
Base = {
...
export type Indent = {
Offset: number?}ReGui:DefineElement("Indent", {
Base = {
...
export type Bullet = {
Padding: number?}ReGui:DefineElement("Bullet", {
Base = {
...
Expand: (Row) -> Row}ReGui:DefineElement("Row", {
Base = {
...
return Canvas, Object
end,})--TODO-- Verticalexport type SliderIntFlags = {
Value: number?,
Format: string?,
Label: string?,
Progress: boolean?,
...
MakeProgress: (SliderInt) -> nil?,}ReGui:DefineElement("SliderBase", {
Base = {
...
Label: string,
Value: number,} & SliderIntFlagsReGui:DefineElement("SliderEnum", {
Base = {
...
end,})ReGui:DefineElement("SliderInt", {
Base = {
...
Create = Elements.SliderBase,})ReGui:DefineElement("SliderFloat", {
Base = {
...
Value: number?,
ReadOnly: boolean?,
SetValue: (DragIntFlags, number) -> DragIntFlags,}ReGui:DefineElement("DragInt", {
Base = {
...
return Class, Object
end,})ReGui:DefineElement("DragFloat", {
Base = {
...
Create = Elements.DragInt,})ReGui:DefineElement("MultiElement", {
Base = {
...
})endexport type InputColor3Flags = {
Label: string?,
Value: Color3?,
...
})endexport type InputCFrameFlags = {
Label: string?,
Value: CFrame?,
...
})endGenerateMultiInput("InputInt2", "InputInt", 2, {NoButtons=true})GenerateMultiInput("InputInt3", "InputInt", 3, {NoButtons=true})GenerateMultiInput("InputInt4", "InputInt", 4, {NoButtons=true})GenerateMultiInput("SliderInt2", "SliderInt", 2)GenerateMultiInput("SliderInt3", "SliderInt", 3)GenerateMultiInput("SliderInt4", "SliderInt", 4)GenerateMultiInput("SliderFloat2", "SliderFloat", 2)GenerateMultiInput("SliderFloat3", "SliderFloat", 3)GenerateMultiInput("SliderFloat4", "SliderFloat", 4)GenerateMultiInput("DragInt2", "DragInt", 2)GenerateMultiInput("DragInt3", "DragInt", 3)GenerateMultiInput("DragInt4", "DragInt", 4)GenerateMultiInput("DragFloat2", "DragFloat", 2)GenerateMultiInput("DragFloat3", "DragFloat", 3)GenerateMultiInput("DragFloat4", "DragFloat", 4)GenerateColor3Input("InputColor3", "InputInt3")GenerateColor3Input("SliderColor3", "SliderInt3")GenerateColor3Input("DragColor3", "DragInt3")GenerateCFrameInput("InputCFrame", "InputInt3")GenerateCFrameInput("SliderCFrame", "SliderInt3")GenerateCFrameInput("DragCFrame", "DragInt3")ReGui:DefineElement("SliderProgress", {
Base = {
...
SetPercentage: (ProgressBar, Value: number) -> nil}ReGui:DefineElement("ProgressBar", {
Base = {
...
Items: {[number?]: any}?,
GetItems: (() -> table)?,}ReGui:DefineElement("Combo", {
Base = {
...
return Class, Object 
end,})--ReGui:DefineElement("ComboFilter", {--
Base = {--
...
Collapsible = true,
Open = true,
Focused = false}function WindowClass:Tween(Data)
ReGui:CheckConfig(Data, {

Tweeninfo = self:GetThemeKey("AnimationTweenInfo")
})
return Animation:Tween(Data)end
...
Objects = Objects
})endexport type TitleBarCanvas = {
Right: table,
Left: table,}function WindowClass:MakeTitleBarCanvas(): TitleBarCanvas
...
self:SetVisible(not IsVisible)end
function WindowClass:GetWindowSize(): Vector2
return self.WindowFrame.AbsoluteSizeend
function WindowClass:GetTitleBarSizeY(): number
local TitleBar = self.TitleBar
return TitleBar.Visible and TitleBar.AbsoluteSize.Y or 0end
...
Body.Interactable = Interactableend
...
--// Update colors
self:SetFocusedColors(NewState)end
function WindowClass:GetThemeKey(Key: string)
return ReGui:GetThemeKey(self.Theme, Key)end
...
return selfend--// Window removal function function WindowClass:Remove()
local Window = self.WindowFrame
local WindowClass = self.WindowClass
...
return ContentCanvas:MenuBar(Config, ...)endexport type WindowFlags = {
AutoSize: string?,
...
Close: (Window) -> nil,}ReGui:DefineElement("Window", {
Export = true,
Base = {
...
AutoSelectNewTabs: boolean?,} & WindowFlagsReGui:DefineElement("TabsWindow", {
Export = true,
Base = {
...
SetPopupVisible: (PopupCanvas, Visible: boolean) -> nil}ReGui:DefineElement("PopupCanvas", {
Base = {
...
return Canvas, Object
end,})ReGui:DefineElement("PopupModal", {
Export = true,
Base = {
